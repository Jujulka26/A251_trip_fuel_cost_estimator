...
class _HomePageState extends State<HomePage> {
  String estimatedCost = '0.00', message = '';
  String fuelType =
  ...
  void calculateCost() {
    ...
    if (distance < 0 || efficiency < 0) {
      message = 'Error: Distance and Fuel Efficiency cannot be negative.';
      isError = true;
    } else if (efficiency == 0) {
      message = 'Error: Fuel Efficiency cannot be zero.';
      isError = true;
    } else if (distance == 0) {
      message =
